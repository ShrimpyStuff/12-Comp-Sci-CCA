...
import numpy as np
from Pynite import FEModel3D, Rendering
...
def analyze_structure(dome) -> FEModel3D: # Hopefully works for both Geodesic and Catenary=based domes
    ...
    model.add_section("Section", A, Iy, Iz, J)  # Example section properties (A, Iy, Iz, J)
    ...
    model.add_node_load("Apex", direction="FZ", P=-5e-4)  # Example load (force in Z direction)
